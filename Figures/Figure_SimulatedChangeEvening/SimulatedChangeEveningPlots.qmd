---
title: "Simulated Change Evening Plots"
format: html
---
...
Read in the dataset
```{r}
FileName <- paste0("data/ResidualQCEvening", "3L", ".csv")
...
```{r}
TheFileName <- paste0("EveningQC_", "3L", "SelectFluorophores")
...
```{r}
TheFileName <- paste0("EveningQC_", "3L", "RandomFluorophores")
...
Read in the dataset
```{r}
FileName <- paste0("data/ResidualQCEvening", "4L", ".csv")
Data <- read.csv(FileName, check.names=FALSE)
```
...
```{r}
TheFileName <- paste0("EveningQC_", "4L", "SelectFluorophores")
...
```{r}
TheFileName <- paste0("EveningQC_", "4L", "RandomFluorophores")
...
Read in the dataset
```{r}
FileName <- paste0("data/ResidualQCEvening", "5L", ".csv")
Data <- read.csv(FileName, check.names=FALSE)
```
...
```{r}
TheFileName <- paste0("EveningQC_", "5L", "SelectFluorophores")
...
```{r}
TheFileName <- paste0("EveningQC_", "5L", "RandomFluorophores")
